...
ActiveRecord::Schema.define(version: 2021_08_07_232118) do
  ...
  create_table "order_items", force: :cascade do |t|
    ...
    t.index ["parkings_id"], name: "index_order_items_on_parkings_id"
  end
  ...
  add_foreign_key "order_items", "parkings", column: "parkings_id"
